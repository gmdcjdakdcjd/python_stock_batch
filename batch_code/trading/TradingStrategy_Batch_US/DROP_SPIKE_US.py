...
if drop_candidates:
    ...
    print("📉 [일봉] 전일 대비 7% 이상 하락 & 종가 ≥ $10 종목 리스트:\n")
    ...
    print(f"✅ [DB저장완료] {len(drop_candidates)}건 (result_id={result_id})")

else:
    print("\n😴 [일봉] 전일 대비 7% 이상 하락한 종목 없음 — DB 저장 생략.")
